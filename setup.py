#!/usr/bin/env python
descr = """Python module that operates on heterogeneous data systems and detects size-k modules of objects, that,
        taken together, appear most significant to another set of objects."""
...
URL = 'http://github.com/marinkaz/medusa'
LICENSE = 'GPLv2'
DOWNLOAD_URL = URL
PACKAGE_NAME = 'medusa'
EXTRA_INFO = dict(
